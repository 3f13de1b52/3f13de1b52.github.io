...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		...
		exports["vue-detached.scrollbar"] = factory();
	else
		root["vue-detached.scrollbar"] = factory();
})(this, function() {
...
__vue_options__.__file = "E:\\webdev\\npm-packages\\vue-detached-scrollbar\\src\\components\\Gallery.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-abf26e7a", __vue_options__)
  } else {
    hotAPI.reload("data-v-abf26e7a", __vue_options__)
  }
})()}
...
__vue_options__.__file = "E:\\webdev\\npm-packages\\vue-detached-scrollbar\\src\\components\\ScrollBar.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7307d337", __vue_options__)
  } else {
    hotAPI.reload("data-v-7307d337", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] ScrollBar.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
exports.default = {
    ...
    created: function created() {
        ...
        this.$scrollBus.$on('change', function (msg) {
            _this.calculateBack(msg);
        });
    },

    methods: {
        calculateBack: function calculateBack(distPerc) {
            var posOfBar = distPerc * this.holderWidth / 100;
            document.getElementById(this.wrapperId).scrollLeft = posOfBar;
        }
    },
    computed: {
        holderWidth: function holderWidth() {
            var full = document.getElementById(this.wrapperId).scrollWidth;
            var client = document.getElementById(this.wrapperId).offsetWidth;
            return full - client;
        }
    }
};
...
exports.default = {
    ...
    methods: {
        ...
        calculatePosition: function calculatePosition(event) {
        ...
        calculateSliderOffset: function calculateSliderOffset() {
            var slider = document.getElementById(this.sliderId);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-7307d337", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-abf26e7a", module.exports)
  }
}
...
exports.Gallery = exports.scrollBus = exports.ScrollBar = undefined;
...
Object.defineProperty(_vue2.default.prototype, '$scrollBus', {
    get: function get() {
        return this.$root.scrollBus;
    }
});

var scrollBus = new _vue2.default({});

exports.ScrollBar = _ScrollBar2.default;
exports.scrollBus = scrollBus;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_detached_scrollbar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_vue_detached_scrollbar__);
...
const app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  data: {
    scrollBus: __WEBPACK_IMPORTED_MODULE_3_vue_detached_scrollbar__["scrollBus"]
  },
  el: '#app',
